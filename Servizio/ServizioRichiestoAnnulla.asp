<%
  NomePagina="ServizioRichiestoAnnulla.asp"
...
function registra(act)  {
    ...
    xx=ElaboraControlli();
     ...
     xx=myConfirm("Annullamento Richiesta","Conferma operazione",act);
}
...
PaginaReturnOk = ""
   ...
   if oper<>"" and instr("REGISTRA_ANSER",oper)>0 then 
	  'devo stornare i pagamenti
	  if Oper="ANSER" then 
	     IdStatoServizio = "ANNU"
		 DescStatoServizio = "Annullato"
	  end if 
	  ...
	  xx = UpdateFlussoProcessoServizioRichiesto(0,IdAttivita,IdNumAttivita,"ANNULLA")
   end if 
    ...
    %>    
        ...
        <div class="container-fluid">
            ...
            <div class="row">
				...
				<% end if %>			
                <div class="col-11"><h3>Annullamento Richiesta Servizio</h3>
                </div>
            </div>
            <div class="row">
               <div class="col-4">
			...
			<div class="row">
			   <div class="col-11">
                  <div class="form-group ">
					 ...
					 <input type="text" readonly class="form-control" value="<%=NoteServizio%>" >
                  </div>		
			   </div>
			</div>
	        <%end if %>
			<div class="row">
			   <div class="col-11">
                  <div class="form-group ">
					 ...
					 <input type="text" readonly class="form-control" value="<%=NoteServizioCliente%>" >
                  </div>		
			   </div>
			...
			<div class="row">
			   <div class="col-11">
                  <div class="form-group ">
				     <%xx=ShowLabel("Motivo Annullamento")
					   NameLoaded= NameLoaded & "NoteStatoServizio,TE;" 
          ...
          <!--#include virtual="/gscVirtual/include/showErrorDivRow.asp"-->
           ...
           <div class="row">
		     ...
		     <div class="mx-auto">
		         <button type="button" onclick="registra('ANSER')" class="btn btn-danger">Annulla Servizio</button>
		     </div>
