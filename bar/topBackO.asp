<!--#include virtual="/gscVirtual/common/parametri.asp"-->
      <nav class="navbar navbar-expand-lg navbar-light <%=default_nav_bar_bg_color%> " style="margin-bottom: 3px;">
		...
		<div>
			<span class="text-warning" >&nbsp;Utente (Back Office) </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item active">
              <a class="nav-link <%=default_nav_span_text_color%>" href="/gscVirtual/bar/BackODashboard.asp"><i class="fa fa-home">&nbsp;</i>Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link <%=default_nav_span_text_color%>" href="/gscVirtual/configurazioni/????.asp"><i class="fa fa-user">&nbsp;</i>Profilo</a>
            </li>
            <li class="nav-item">
