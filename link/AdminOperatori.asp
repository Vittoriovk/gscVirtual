...
<body>
  ...
  <div class="d-flex" id="wrapper">
	<%
	  TitoloNavigazione="Anagrafica Operatori"
		   ...
		   <div class="row">
				...
				<div class="col-md-6 col-lg-2 col-xlg-3">
					<div class="card card-hover">
						<a href="<%=VirtualPath%>configurazioni/collaboratori/ListaOperatore.asp">
							<div class="box bg-success text-center">
								<h1 class="font-light text-white"></h1>
								<h6 class="text-white">Anagrafica Utente</h6>
							</div>
						</a>
					</div>
				</div>			
