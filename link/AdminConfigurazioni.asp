...
<body>
  ...
  <div class="d-flex" id="wrapper">
	<%
	  ...
	  Session("swap_PaginaReturn") = "link/AdminConfigurazioni.asp"
		   ...
		   <div class="row">
				...
				<div class="col-md-6 col-lg-2 col-xlg-3">
				   <div class="card card-hover">
					  <a href="<%=VirtualPath%>configurazioni/prodotti/ProfiloProdotti.asp">
						 <div class="box bg-success text-center">
							<h1 class="font-light text-white"></h1>
							<h6 class="text-white">Profilo Prodotti</h6>
						 </div>
					  </a>
				   </div>
				</div>			
