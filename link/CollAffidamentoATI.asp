<%NomePagina="CollAffidamentoATI.asp"%>
...
<body>
  ...
  <div class="d-flex" id="wrapper">
   <%
     TitoloNavigazione="Affidamento ATI per cliente"
     Session("opzioneSidebar")="affa"
         ...
         <div class="row">
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
               <div class="card card-hover">
				  <%
				  op="configurazioni/clienti/ClienteAti.asp"
                  ...
                  <a href="#" onclick="send01('<%=op%>','<%=de%>')">
                     <div class="box bg-info text-center">
                        ...
                        <h6 class="text-white">Gestione ATI (ass.tem.Impresa) Cliente</h6>
                     </div>
                  </a>
               </div>
            </div>
