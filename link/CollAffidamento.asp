<%NomePagina="CollAffidamento.asp"%>
	...
	function send01(op,de)
	{
      ...
      <div class="container-fluid bg-light">
         <div class="row">
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
               <div class="card card-hover">
				  <%
				  op="configurazioni/clienti/Affidamento/NuovaRichiesta.asp"
				  de="Nuova richiesta di affidamento "
				  
				  %>
                  <a href="#" onclick="send01('<%=op%>','<%=de%>')">
                     <div class="box bg-success text-center">
                        <h1 class="font-light text-white"></h1>
                        <h6 class="text-white">Nuova Richiesta di Affidamento</h6>
                     </div>
                  </a>
               </div>
            </div>
            <div class="col-md-6 col-lg-2 col-xlg-3">
               <div class="card card-hover">
                  <a href="<%=VirtualPath%>configurazioni/clienti/Affidamento/ListaRichiesta.asp">
                     <div class="box bg-success text-center">
                        <h1 class="font-light text-white"></h1>
                        <h6 class="text-white">Gestione Richiesta Affidamento</h6>
                     </div>
                  </a>
               </div>
            </div>
         ...
         <div class="row">
			...
			<%end if %>
			<%if flagGesAti=true then %>
            <div class="col-md-6 col-lg-2 col-xlg-3">
               <div class="card card-hover">
                  <a href="<%=VirtualPath%>configurazioni/clienti/ValidazioneATIColl.asp">
                     <div class="box bg-info text-center">
                        <h1 class="font-light text-white"></h1>
