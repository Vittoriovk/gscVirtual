<%
  NomePagina="ListaProvvigioniRete.asp"
  titolo="Menu - Provvigioni Rete"
%>
...
if PaginaReturn="" then 
   PaginaReturn="link/AdminProvvigioni.asp"
end if 
...
if Oper="CALL_INS" or Oper="CALL_UPD" then
   ...
   Session("swap_TipoProvvigione") = "RETE"
   response.redirect RitornaA("configurazioni/Provvigioni/ModificaProvvigione.asp")
   response.end 
	...
	%>	
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-11"><h3>Regole Provvigioni Rete</h3>
				</div>
			</div>
			<%
			AddRow=true
...
<%
			...
			MySql = MySql & " Where TipoRegola in ('RETE')  "
