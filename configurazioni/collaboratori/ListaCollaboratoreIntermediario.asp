<%
  NomePagina="ListaCollaboratoreIntermediario.asp"
  titolo="Menu - Collaboratori "
%>
...
if Oper="CALL_INS" or Oper="CALL_UPD" then
   ...
   response.redirect RitornaA("configurazioni/Collaboratori/CollaboratoreIntermediarioModifica.asp")
   response.end 
