<%
  NomePagina="GruppoProdottiModifica.asp"
  titolo="Modifica Raggruppamento Prodotti"
...
<%
  ...
  <div class="container-scroller">
	...
	<div class="container-fluid page-body-wrapper">
		...
		<div class="main-panel">          
			...
			<!--#include virtual="/gscVirtual/include/Anchor.asp"-->			
				<div class="col-11"><h3>Gestione Raggruppamento Prodotto:</b> <%=DescPageOper%> </h3>
				</div>
			</div>
   ...
   ao_lbd = "Descrizione Raggruppamento"       'descrizione label 
   ...
   ao_Plh = "|placeholder=Descrizione Raggruppamento"              'placeholder
   %>
