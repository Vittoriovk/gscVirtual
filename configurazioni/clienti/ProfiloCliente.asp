...
<%
  ...
  IdCliente = cdbl(Session("LoginIdCliente"))
  ...
  'puo' aggiornare solo password 
   if Oper=ucase("update") then 
      ...
      if Cdbl(IdCliente)=0 then 
		 if Cdbl(IdAccount)=0 then 
            ...
            MyQ = "" 
            MyQ = MyQ & " Insert into Cliente (IdAccount,IdAzienda,Denominazione,IdTipoDitta,Livello)"
   ...
   if cdbl(IdCliente)>0 then
      ...
      IdTipoColl=Getdiz(DizDatabase,"IdTipoCliente")
...
<div class="d-flex" id="wrapper">
	...
	%>	
		...
		<!--#include virtual="/gscVirtual/include/Anchor.asp"-->						
				<div class="col-11"><h3>Profilo Personale</h3>
				</div>
			</div>
   ...
   <div class="row">
	  ...
	  <div class="col-3">
	      ...
	      <input type="text" <%=readonly%> name="<%=nome%>" id="<%=nome%>" value="<%=valo%>" 
                 class="form-control " placeholder="gg/mm/aaaa" title="formato : gg/mm/aaaa" >
	  </div> 	  	  
      <div class="col-2">
         <p class="font-weight-bold"> </p>
      </div>	  
