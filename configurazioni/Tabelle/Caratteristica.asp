...
if Oper="CALL_DETT" then 
    ...
    Session("swap_PaginaReturn")   = "configurazioni/tabelle/Caratteristica.asp"
    response.redirect virtualPath & "configurazioni/tabelle/CaratteristicaDettaglio.asp"
    response.end 
End if 
						...
						<div class="card">
							<form name="Fdati" Action="<%=NomePagina%>" method="post">
								<div class="card-body d-flex">	
									...
									<h2 style="height: 25px; margin-left: 1rem;">Elenco Rischi - Template</h2>
								</div>
								<div class="card-body">
									...
									MySql = "" 
									MySql = MySql & " SELECT DescAnagServizio " ' Seleziona solo il campo DescAnagServizio
									MySql = MySql & " FROM AnagServizio "
									MySql = MySql & " WHERE DescAnagServizio LIKE '%" & apici(cerca_testo) & "%' "
									MySql = MySql & " ORDER BY DescAnagServizio "
									...
									<div class="table-responsive">
										<table class="table">
											<thead>
												<tr>
													<th>
														<h4><b>Servizio di riferimento</b></h4>															
													</th>
											...
											<tr>
												...
												<td class="text-center">
													...
													<%RiferimentoA="col-2;#;;2;dett;Caratteristiche;;AttivaFunzione('CALL_DETT','" & Id & "');N"%>
													<!--#include virtual="/gscVirtual/include/Anchor.asp"-->			
													<%end if %>
												</td>
											</tr>
