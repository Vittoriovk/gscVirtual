<%
  NomePagina="Elenco.asp"
  titolo="Anagrafica Elenco"
%>
...
if Oper="CALL_INS" or Oper="CALL_UPD" or Oper="CALL_DEL" or Oper="CALL_DETT" then 
    xx=RemoveSwap()
    Session("TimeStamp")=TimePage
	KK=Request("ItemToRemove")
	Session("swap_IdElenco")   = KK
	Session("swap_OperTabella")   = Oper
    Session("swap_PaginaReturn")  = "configurazioni/tabelle/Elenco.asp"
	if Oper="CALL_DETT" then 
	   response.redirect virtualPath & "configurazioni/elenchi/elenchiDettaglio.asp"
	else 
       response.redirect virtualPath & "configurazioni/tabelle/ElencoDettaglio.asp"
	end if 
    response.end 
End if 
						...
						<div class="card">
							<form name="Fdati" Action="<%=NomePagina%>" method="post">
								...
								<div class="card-body">
									<div class="form-group">
										<div class="template-demo d-flex justify-content-between flex-nowrap">
											<div style="float:left; display:block;">
												<button style="font-size: 1.25rem; margin-right: 1rem;" class="add btn btn-primary todo-list-add-btn" type="button" onclick="AttivaFunzione('CALL_INS','0');">Inserisci Elenco</button>
											</div>
									...
									MySql = "" 
									MySql = MySql & " Select * "
									MySql = MySql & " From Elenco "
									MySql = MySql & " WHERE DescElenco LIKE '%" & apici(cerca_testo) & "%' "
									MySql = MySql & " ORDER BY DescElenco"
									...
									<div class="table-responsive">
										<table class="table">
											...
											<tr>
												<td>
													<input class="form-control" type="text" readonly value="<%=Rs("DescElenco")%>">
												</td>
