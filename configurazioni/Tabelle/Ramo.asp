...
if Oper="CALL_INS" or Oper="CALL_UPD" or Oper="CALL_DEL" then 
	...
	Session("swap_IdRamo")   = KK
	Session("swap_OperTabella")   = Oper
    Session("swap_PaginaReturn")  = "configurazioni/tabelle/Ramo.asp"
    response.redirect virtualPath & "configurazioni/tabelle/RamoDettaglio.asp"
    response.end 
End if 
			...
			<div class="content-wrapper">
				<div class="row">
					<div class="col-lg-12 grid-margin stretch-card">
						<div class="card">
							<form name="Fdati" Action="<%=NomePagina%>" method="post" class="forms-sample">
								<div class="card-body d-flex">	
									<%RiferimentoA=";" & VirtualPath & "SupervisorConfigurazioni.asp;;2;prev;Indietro;;;"%>
									<!--#include virtual="/gscVirtual/include/Anchor.asp"-->
									<h2 style="height: 25px; margin-left: 1rem;">Gestione Ramo</h2>
								</div>
								<div class="card-body">
									...
									MySql = "" 
									MySql = MySql & " SELECT A.*, isnull(B.DescAnagRamo, '') as DescRamoRife "
									MySql = MySql & " FROM Ramo A LEFT JOIN AnagRamo B ON A.IdAnagRamo = B.IdAnagRamo "
									MySql = MySql & " WHERE A.DescRamo LIKE '%" & apici(cerca_testo) & "%' "
									MySql = MySql & " ORDER BY DescRamo "
